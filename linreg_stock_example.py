...
# =============================================================================
# we first train our data but then save it using the pickle
# this way we can come back and run the same code without having to 
# train our data. this could save us a bunch of time when dealing
# with sizeable data. comment multi lines with command+4 and
# undo with command +5 
# =============================================================================
# =============================================================================
